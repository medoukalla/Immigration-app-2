<x-en.head title="Asesoría Fiscal y Laboral - Immiworld" />
...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>Tax and Labour Advisory</h1>
            <p>
               If you carry out an economic activity in Spain, properly managing your tax and labour
obligations is essential to ensure compliance and maintain your business in good standing.

You receive clear guidance to help you understand and manage your obligations efficiently,
avoiding potential issues with the Administration.
            </p>
            <div class="pages-path">
                ...
                <div class="p-path">Tax and Labour Advisory</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Tax and labour management is a fundamental part of running any business.

                    This includes tax filings, Social Security obligations and the proper handling of labour-related
                    matters, all of which must be completed accurately and within established deadlines.

                    You are supported throughout this process, helping you organize and manage the
                    administrative aspects of your activity in a clear and structured way.
                </p>
...
<section style="background: #efefef; padding: 100px 0">
    <div class="base-container w-container">
        <div class="section-rootedness">
            <h2 class="text-center">
                We Help You Manage Your Obligations
            </h2>
            <p class="text-center" style="width: 60%; margin: 0 auto">
                Many individuals and businesses have doubts regarding their tax and labour responsibilities,
especially during the early stages of their activity.

Your situation is carefully reviewed, and you receive clear explanations of your obligations so
you can manage them with confidence and clarity.
            </p>
            <div class="section-rootedness-grid">
                <div class="left-rootedness">
                    <div class="rootedness first-rootedness">
                        ...
                        <p>
                            Within our tax and labour advisory service, you receive assistance with:

Guidance on tax obligations related to your activity
Support in managing tax procedures and filings
Advice on labour matters and Social Security obligations
Resolution of administrative and compliance-related queries

The objective is to ensure that your business remains properly organized and compliant at
all times.
                        </p>
                    </div>
...
representative (procurador).
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Grounds for the Appeal</span>
                                </div>
