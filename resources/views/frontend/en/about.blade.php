...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 255px">
            <h1>About Us</h1>
            <p>
                At Immiworld, you receive specialized legal guidance in
                immigration law, focused on providing clear, reliable and
                tailored solutions for your immigration process in Spain. Each
                case is approached individually, ensuring that your situation is
                carefully analyzed and managed in accordance with current
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Social Integration Residence is a residence permit that
                    allows foreign nationals to reside legally in Spain if they
                    have remained in the country for at least two years prior to
                    submitting the application, and can demonstrate either
                    family ties with other foreign residents holding a valid
                    residence permit or, where such ties cannot be proven,
                    sufficient evidence of social integration in Spain.
                </p>
    ...
    <div class="base-container w-container">
        <div class="call-to-action-box">
            ...
            <div class="call-title">
                Get the legal assistance you need for your<br />
                <span>immigration process in Spain</span>
            </div>
            <p>
                Whether you live in Spain or are planning to move here, our
                expert immigration lawyers will guide you every step of the way.
                We manage your paperwork efficiently so you can focus on your
                new beginning.
            </p>
