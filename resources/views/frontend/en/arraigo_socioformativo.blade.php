    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Training-Based Residence is a temporary residence authorization designed for foreign
                    nationals who have been continuously present in Spain for at least two years and who are
                    either enrolled in, participating in, or committed to undertaking recognized training
                    programmes linked to employment.

                    The training must take place in Spain and be aimed at improving employability, particularly in
                    sectors with a proven demand for workforce.
                </p>
...
to your specific needs and goals, because behind every application there is a personal story.
                ...
                <div class="right-rootedness">
                    <div class="rootedness third-rootedness">
                        ...
                        <p>
                            With hundreds of satisfied clients, Immiworld has built a strong reputation for reliability and
success in handling immigration and residency applications.
                        </p>
                    </div>
                    <div class="rootedness forth-rootedness">
                        ...
                        <p>
                            You receive continuous assistance from the beginning until your case is resolved, ensuring
transparency and professional legal support throughout the entire process.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="win-accordion-wrapper">
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Minimum Continuous Residence in Spain
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        The applicant must prove continuous residence in Spain for a minimum period of two years
prior to submitting the application.
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>No Criminal Record and No Risk to Public Order
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        The applicant must have no criminal record in Spain or in countries where they have resided
during the previous five years, and must not pose a risk to public order or safety.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Not Subject to Entry Bans and Not Irregularly Present</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Applicants must not be subject to an entry ban in Spain or in countries with which Spain has
agreements to that effect.
                            ...
                            <div class="win-accordion-item">
                                ...
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        The corresponding administrative fee must be paid within the legal timeframe to process the
application.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                ...
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        The applicant must be enrolled in or undertaking a valid training programme in Spain, or
formally commit to starting one.

Accepted training includes, among others:

→ Post-compulsory secondary education carried out full-time in authorized institutions
→ Vocational training programmes leading to officially recognized professional

certificates, including all levels regulated by current legislation

→ In-person education programmes for adults

This authorization may also be granted to individuals who commit to undertaking training
promoted by Public Employment Services, particularly those aimed at occupations included
in the official shortage occupation list.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Sufficient Social Integration
                                    </span>
                                </div>
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content">
                                        A favourable integration report must be issued by the competent authority of the
Autonomous Community where the applicant resides.

This report must support the granting of the residence authorization based on the applicant's
