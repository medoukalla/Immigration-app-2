...
employment relationship.
            ...
            <div class="pages-path">
                ...
                <div class="p-path">Social and Labour Integration Residence</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Social and Labour Integration Residence is a temporary residence authorization designed
                    for foreign nationals who have been continuously present in Spain for at least two years and
                    who can demonstrate their connection to the labor market through one or more employment
                    contracts that comply with current legal requirements.
                    This legal pathway allows individuals to regularize their situation when there is a genuine
                    employment opportunity, facilitating both social and professional integration within the
                        ...
                        <div class="win-accordion-wrapper">
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>No Criminal Record and Not Listed as Inadmissible</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        ...
                                        You must also not be listed as inadmissible in Spain or in countries with which Spain has
                            ...
                            <div class="win-accordion-item">
                                ...
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Whether you submit one or multiple contracts, they must guarantee at least the minimum
                                        wage established by law or by the applicable collective agreement, depending on working
                                        hours.
                                        The total working hours must represent at least 20 hours per week.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Employer's Financial Means
                                    </span>
                                </div>
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content">
                                        The employer must be up to date with tax and Social Security obligations and must have
                                        sufficient financial means to meet the commitments established in the employment contract.
                                    </div>
                                </div>
                            </div>
                        </div>
