<x-en.head title="Cancelación de Antecedentes Penales - Immiworld" />
...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>Criminal Record Cancellation</h1>
            <p>
               Criminal record cancellation allows certain convictions to be removed from official records
once the legal requirements and timeframes established by law have been met.

This procedure may be necessary in administrative or employment-related processes, as
criminal records can affect applications and legal procedures.

You receive guidance to determine whether you are eligible and to complete the process
correctly.
            </p>
            <div class="pages-path">
                ...
                <img src=" {{ asset('assets/images/svg/arrow.svg') }}" alt="Path Arrow" />
                <div class="p-path">Criminal Record Cancellation</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Criminal records are not automatically removed once a sentence has been completed.

                    To cancel them, a formal application must be submitted before the relevant authority.

                    Before initiating the procedure, it is essential to verify that the required legal timeframes have
                    passed and that no new offences have been committed during that period.

                    Your situation is carefully reviewed to determine whether you meet the conditions to request
                    cancellation.
                </p>
    ...
    <div class="base-container w-container">
        <div class="section-rootedness">
            ...
            <p class="text-center" style="width: 60%; margin: 0 auto">
                At Immiworld, you receive clear and reliable guidance to manage your legal procedures in
Spain with confidence and security.
            </p>
                ...
                <div class="left-rootedness">
                    <div class="rootedness first-rootedness">
                        ...
                        <div class="number-title">
                            When Can Criminal Records Be Cancelled?
                        </div>
                        <p>
                            Criminal record cancellation can only be requested after a specific period has passed
following the completion of the sentence.

These timeframes vary depending on the type and severity of the penalty imposed.

Each case must be analyzed individually to determine whether the legal conditions are met
before submitting the application.
                ...
                <div class="right-rootedness">
                    <div class="rootedness third-rootedness">
                        ...
                        <div class="number-title">
                            We Help You Manage the Process
                        </div>
                        <p>
                            You receive guidance throughout the entire procedure, ensuring that all requirements are
met and that your application is correctly prepared.

Support includes reviewing your situation, preparing documentation and assisting you during
