...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>REAGRUPACIÓN FAMILIAL
 FAMILY REUNIFICATION</h1>
            <p>
...
regulations.
            ...
            <div class="pages-path">
                ...
                <div class="p-path">Family Reunification</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    Family Reunification is a temporary residence authorization that allows family members of a
                    foreign national legally residing in Spain to obtain their own residence permit, in accordance
                    with the right to family unity recognized under current legislation.
                    This authorization enables certain relatives to reside legally in Spain, provided that all
                    requirements established under immigration law are met.
    ...
    <div class="base-container w-container">
        <div class="section-rootedness">
            ...
            <p class="text-center" style="width: 60%; margin: 0 auto">
                You are guided step by step through every stage of your immigration process. Complex
legal procedures are explained clearly, so you always know what to expect and how to
proceed.
            </p>
                        ...
                        <div class="win-accordion-wrapper">
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Sponsor's Residence Status and Sufficient Financial Means
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        The sponsor (the foreign national living in Spain) must have resided legally for at least one
year and have applied for or obtained authorization to reside for at least another year.
In addition, the sponsor must demonstrate sufficient financial resources to provide for the
family, as well as adequate housing.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Relatives Eligible for Reunification
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Family reunification typically applies to:
→ Spouse or person with an equivalent emotional relationship (registered partners).
→ Children of the sponsor and/or their spouse/partner, including adopted children,
provided they are under 18 or have a disability.
→ Parents (ascendants) of the sponsor or their spouse/partner, generally over 65 years
old, provided they are financially dependent and there are justified reasons for their
residence in Spain.
→ Exceptionally, adult children who act as caregivers of the sponsor, when the sponsor has a
recognized dependency status.
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>No Criminal Record and No Threat to Public Order, Security or Public Health</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        You must not have a criminal record in Spain or in any country where you have lived during
the five years prior to entering Spain.
This requirement ensures compliance with public safety and legal standards.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Not Subject to Entry Bans and Not Irregularly Present in Spain</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
...
corresponding fee within the established deadline.
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Health Insurance and No Serious Illnesses
                                    </span>
                                </div>
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content">
                                        You must have public or private health insurance with an authorized provider in Spain and
not suffer from any diseases that may pose a serious public health risk under the
