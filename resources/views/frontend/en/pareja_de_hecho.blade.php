<x-en.head title="Pareja de Hecho - Immiworld" />
...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>Civil Procedures</h1>
            <p>
                Registering a partnership allows the legal recognition of a
                stable relationship between two individuals in Spain. This
                procedure may be required for various administrative, legal or
                immigration-related processes. You receive guidance throughout
                the entire process to ensure that your application is correctly
            ...
            <div class="pages-path">
                ...
                <img
                    ...
                    alt="Path Arrow"
                />
                <div class="p-path">Cervices</div>
                <img
                    src=" {{ asset('assets/images/svg/arrow.svg') }}"
                    alt="Path Arrow"
                />
                <div class="p-path">Civil procedure</div>
                <img
                    src=" {{ asset('assets/images/svg/arrow.svg') }}"
                    alt="Path Arrow"
                />

                <div class="p-path">Civil partnership</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    A registered partnership provides legal recognition of a
                    cohabiting relationship between two people. To complete this
                    procedure, specific legal requirements must be met and the
                    appropriate documentation must be submitted to the competent
                    authority. You are guided through each stage of the process,
                    ensuring that all requirements are fulfilled and that your
    ...
    <div class="base-container w-container">
        <div class="section-rootedness">
            ...
            <p class="text-center" style="width: 60%; margin: 0 auto">
                The requirements and procedures for registering a partnership
                may vary depending on the autonomous community. For this reason,
                it is essential to understand the specific conditions applicable
                in your case. You receive support in reviewing your
                documentation and clear guidance on each step to ensure the
                process is completed correctly and without complications.
            </p>
                        ...
                        <div class="win-accordion-wrapper">
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span
                                        >To register as a partnership, it is
                                        generally necessary to meet the
                                        following conditions:
                                    </span>
                                </div>
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content" style="padding-bottom: 0; padding-top:0">
                                        <ul style="margin-top:0; margin-bottom:0">
                                            <li>Proof of a stable cohabiting relationship.</li>
                                            <li>Not being legally married to another person.</li>
                                            <li>Being registered at the same address (empadronamiento).</li>
                                            <li>Submission of the required documentation to the competent authority.</li>
                                        </ul>
                                        <p style="margin-top: 0">
                                            These requirements may vary depending on the autonomous community where the
