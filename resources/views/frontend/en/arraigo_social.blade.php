<x-en.head title="Immiworld - Arraigo Social" />
...
to integrate into Spanish society.
            ...
            <div class="pages-path">
                ...
                <div class="p-path">Social Integration Residence</div>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="win-accordion-wrapper">
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Family Ties and Financial Means</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Spanish immigration law refers to spouses or registered partners, as well as first-degree
                                        relatives in the direct line.
                                        It is essential that these family ties are with foreign nationals who already hold a valid
                                        residence permit in Spain, and that sufficient financial means are demonstrated.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                ...
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content">
                                        If family ties cannot be proven, the competent authority of the Autonomous Community
                                        where you reside must issue a favourable report recommending the granting of the
                                        residence authorization based on your level of social integration.
                                    </div>
                                </div>
                            </div>
                        </div>
