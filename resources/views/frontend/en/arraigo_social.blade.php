...
<!-- Top menu navbar -->
            ...
            <div class="doc-wrapper w-layout-grid">
                ...
                <div class="doc-block-wrapper doc-block-right">
                    <div class="doc-block top">
                        ...
                        <b>Proof of Stay in Spain:</b> <br> <p> Demonstrate continuous residence in Spain for at least three years.
                            </p>
                    </div>
                    <div class="doc-block top">
                        <img src="{{ asset('assets/images/svg/badge-4.svg') }}" alt="Badge">
                        <b>Payment of the Corresponding Fee:</b> <br> <p> Provide proof of payment for the application fee for the social root residence.
                            </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Necessary documents -->
    <x-en.necessary-documents service="Arraigo Social" />
