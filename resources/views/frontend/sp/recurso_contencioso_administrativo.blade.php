            ...
            <div class="doc-wrapper w-layout-grid">
                <div class="doc-block-wrapper doc-block-left">
                    <div class="doc-block">
                        ...
                        <p>Realizamos una consulta inicial para conocer la situación del cliente y analizar la resolución negativa. Evaluamos los
                            motivos de la denegación y le explicamos los pasos y plazos del proceso judicial, resolviendo todas sus dudas.</p>
                    </div>
                    <div class="doc-block">
                        <img src="{{ asset('assets/images/svg/badge-2.svg') }}" alt="Badge">
                        <b>Revisión y Envío de Documentación</b><br>
                        <p>Revisamos detalladamente la resolución y preparamos una estrategia sólida. Ayudamos al cliente a reunir cualquier
                            documentación adicional que pueda reforzar su caso. </p>
                    </div>
                </div>
                <div class="doc-block-wrapper doc-block-right">
                    <div class="doc-block">
                        ...
                        <p>Redactamos el recurso y lo presentamos ante el juzgado competente, cumpliendo con los requisitos legales y
                            respetando los plazos establecidos. Nos encargamos de que toda la documentación sea entregada correctamente. </p>
                    </div>
                    <div class="doc-block">
                        <img src="{{ asset('assets/images/svg/badge-4.svg') }}" alt="Badge">
                        <b>Asesoría Posterior</b><br>
                        <p>Informamos al cliente sobre el resultado del recurso. Si es favorable, le orientamos en los próximos pasos para
                            regularizar su situación. En caso desfavorable, asesoramos sobre opciones legales adicionales que se puedan
                            emprender.</p>
                    </div>
                </div>
            </div>
