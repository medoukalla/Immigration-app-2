<x-sp.head title="Pareja de Hecho - Immiworld" />
...
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>Trámites Civiles</h1>
            <p>
                El registro de una pareja de hecho permite el reconocimiento
                legal de una relación estable entre dos personas en España.
                Este trámite puede ser necesario para diversos procedimientos
                administrativos, legales o relacionados con la inmigración.
                Recibes orientación durante todo el proceso para garantizar que
            ...
            <div class="pages-path">
                ...
                <img
                    ...
                    alt="Path Arrow"
                />
                <div class="p-path">Servicios</div>
                <img
                    src=" {{ asset('assets/images/svg/arrow.svg') }}"
                    alt="Path Arrow"
                />
                <div class="p-path">Trámites civiles</div>
                <img
                    src=" {{ asset('assets/images/svg/arrow.svg') }}"
                    alt="Path Arrow"
                />

                <div class="p-path">Pareja de hecho</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="without-bottom-spacing">
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    La pareja de hecho otorga reconocimiento legal a una
                    relación de convivencia entre dos personas. Para completar
                    este trámite, deben cumplirse requisitos legales específicos
                    y presentarse la documentación correspondiente ante la
                    autoridad competente. Te acompañamos en cada etapa del
                    proceso, garantizando que todos los requisitos se cumplan y
                    que tu solicitud esté correctamente preparada.
                </p>
    ...
    <div class="base-container w-container">
        <div class="section-rootedness">
            ...
            <p class="text-center" style="width: 60%; margin: 0 auto">
                Los requisitos y procedimientos para registrar una pareja de
                hecho pueden variar según la comunidad autónoma. Por ello, es
                fundamental conocer las condiciones específicas aplicables a tu
                caso. Recibes apoyo en la revisión de tu documentación y
                orientación clara en cada paso para garantizar que el proceso
                se complete correctamente y sin complicaciones.
            </p>
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span
                                        ...
                                        generalmente es necesario cumplir las
                                ...
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content" style="padding-bottom: 0; padding-top:0">
                                        <ul style="margin-top:0; margin-bottom:0">
                                            <li>Acreditar una relación estable de convivencia.</li>
                                            <li>No estar casado legalmente con otra persona.</li>
                                            <li>Estar empadronado en el mismo domicilio.</li>
                                            <li>Presentar la documentación requerida ante la autoridad competente.</li>
                                        </ul>
                                        <p style="margin-top: 0">
                                            Estos requisitos pueden variar según la comunidad autónoma donde se realice
el registro.
                                        </p>
                                    </div>
                                </div>
