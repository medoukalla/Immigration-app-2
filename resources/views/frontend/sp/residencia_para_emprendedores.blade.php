            ...
            <div class="doc-wrapper w-layout-grid">
                <div class="doc-block-wrapper doc-block-left">
                    <div class="doc-block">
                        ...
                        <p>Ofrecemos una consulta inicial para entender su proyecto y verificar que cumpla con los requisitos básicos.
                            Evaluamos la innovación del proyecto y los recursos disponibles. </p>
                    </div>
                    <div class="doc-block">
                        <img src="{{ asset('assets/images/svg/badge-2.svg') }}" alt="Badge">
                        <b>Revisión y Envío de Documentación</b><br>
                        <p>Le ayudamos a elaborar un plan de negocio sólido que incluya descripción del producto o servicio, análisis de
                            mercado, proyecciones financieras y plan de creación de empleo. Además, le asistimos en la obtención de
                            certificaciones y licencias necesarias según el sector. </p>
                    </div>
                ...
                <div class="doc-block-wrapper doc-block-right">
                    <div class="doc-block">
                        ...
                        <p>Presentamos la solicitud de residencia con toda la documentación requerida, asegurándonos de que cumpla con los
                            requisitos legales y se complete correctamente. </p>
                    </div>
                    <div class="doc-block">
                        <img src="{{ asset('assets/images/svg/badge-4.svg') }}" alt="Badge">
                        <b>Asesoría Posterior </b><br>
                        <p>Al recibir la resolución, le orientamos en los pasos para su llegada a España, incluyendo el empadronamiento y la
                            obtención del NIE. Además, ofrecemos asesoría continua sobre renovaciones y ampliaciones de su actividad
                            empresarial. </p>
                    </div>\
                </div>
            </div>
