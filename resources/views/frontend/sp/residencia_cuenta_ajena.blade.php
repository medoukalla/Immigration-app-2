<x-sp.head title="Immiworld - Residencia por Cuenta Ajena" />

<x-sp.main-navbar route="{{route('frontend.residencia_cuenta_ajena') }}" />

<!-- Banner hero section -->
<div class="pages-banner blog">
    <div class="base-container w-container">
        <div class="min-hero-wrapper" style="min-height: 225px">
            <h1>Residencia temporal y trabajo por cuenta ajena</h1>
            <p>
               Es una autorización que habilita a la persona
extranjera a residir en España y desarrollar una
actividad laboral para un tercero, dentro de los
límites y condiciones establecidos por la
legislación vigente.
            </p>
            <div class="pages-path">
                ...
                <div class="p-path">Residencia Temporal y Trabajo por Cuenta Ajena</div>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="base-container w-container">
            <div class="s-services">
                ...
                <p class="text-center">
                    ...
                    cuenta ajena está destinada a personas extranjeras que
                    desean trabajar en España para una empresa o
                    empleador, obteniendo simultáneamente el derecho de
                    residencia y de trabajo.

                    Esto permite el ejercicio de una actividad laboral por
                    cuenta ajena, en las condiciones fijadas en la resolución
                    administrativa, pudiendo quedar limitada a un ámbito
                    territorial, un sector de actividad o un empleador
                    concreto, especialmente en las autorizaciones iniciales.

                    Se trata de una de las vías ordinarias de acceso al
                    mercado laboral español para personas extranjeras,
                    facilitando su integración profesional y social conforme
                    al marco legal establecido en la normativa de extranjería.
                </p>
    ...
    <div class="base-container w-container">
        <div class="section-rootedness">
            ...
            <p class="text-center" style="width: 60%; margin: 0 auto">
                Nuestro equipo te acompañará paso a paso en cada fase
de tu proceso migratorio. Todo ello con la idea de
transformar procedimientos legales complejos en
acciones claras y comprensibles, para que siempre sepas
qué hacer y qué esperar de cada paso.
            </p>
...
proceso, garantizando profesionalidad, transparencia y
                        ...
                        <div class="win-accordion-wrapper">
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Situación Nacional de Empleo
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        De forma trimestral, el Servicio Público de Empleo
Estatal ("SEPE") elaborará un catálogo de ocupaciones
de difícil cobertura que permita la contratación de la
persona extranjera.

Igualmente, dependiendo de los convenios que España
tenga con terceros Estados, o si hablamos de actividades
de temporada, la situación nacional de empleo no
siempre será de aplicación.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Contrato de Trabajo
                                    </span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Deberá de estar firmado por la empresa o empleador y
por la persona trabajadora. La cual, según el caso, deberá
de acreditar tener la capacitación profesional exigida
para la profesión

La fecha de comienzo del mismo deberá estar
condicionada al momento de eficacia de la autorización
de residencia y las condiciones deberán de ajustarse a lo
establecido por la normativa vigente así como el
convenio colectivo en cuestión.
                            ...
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Carecer de Antecedentes Penales y No Representar
una Amenaza para el Orden Público, Seguridad o
Salud Pública</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        No sólo tendrías que carecer de ellos en España, sino
también en los países donde hayas residido durante los
cinco últimos años anteriores a la fecha de entrada en
España, por delitos previstos en el ordenamiento jurídico
español.

Este requisito tiene como finalidad garantizar una
convivencia segura y conforme a la normativa vigente.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>No Figurar como Rechazable ni Encontrarse
Dentro del Plazo de No Retorno a España</span>
                                </div>
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        En este caso sería con países con los que España tenga
firmado algún tipo de convenio en el que no acepten a
personas que dicho país ha prohibido la entrada
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                ...
                                <div class="win-accordion-body">
                                    <div class="win-accordion-content">
                                        Como en la mayoría de procedimientos administrativos,
la solicitud conlleva el pago de la tasa correspondiente,
que deberá abonarse dentro del plazo establecido para
que el trámite pueda continuar correctamente.
                                    </div>
                                </div>
                            </div>
                            <div class="win-accordion-item">
                                <div class="win-accordion-header">
                                    ...
                                    <span>Sobre el Empleador
                                    </span>
                                </div>
                                <div class="win-accordion-body no-border">
                                    <div class="win-accordion-content">
                                        Este deberá de estar al corriente con sus obligaciones,
tanto tributarias, como con la Seguridad Social; así como
disponer de medios económicos, personales y materiales
suficientes para cumplir con las obligaciones contenidas
