<x-fr.head title="{{ setting('site.title') . ' - Qui sommes-nous ?' }}" />
...
<div class="wrapper bg-dark">
    ...
    <div class="QuiSommes">
        <div class="container">
            <p class="text-center"><a href="">Accueil Qui</a> <img src="{{ asset('img/arrowRgiht.svg') }}"
                    alt="img" class="img-fluid"> <a href="javascript:void(0)">Qui sommes-nous ?</a>
            </p>
                ...
                <div class="col-lg-7">
                    <div class="itemLeft">
                        <div class="itemLeftLogo">
                            ...
                            <p><span>Immi World</span> est une agence spécialisée dans l'accompagnement des Maghrébins
                                souhaitant
                                <strong>étudier en Espagne.</strong> Nous sommes
                                conscients que la préparation d'un dossier pour étudier à l'étranger peut être une tâche
                                fastidieuse
                                et complexe. C'est
                                pourquoi notre équipe d'experts est là pour vous aider à traverser chaque étape du
                                processus, de la
                                demande d'admission
                                à la <strong>préparation de votre dossier de demande de visa</strong> étudiant.
                            </p>
                        </div>
                        <!-- Nos services start  -->
                                        ...
                                        <div class="media">
                                            ...
                                            <a href="{{ url('fr/page/etudier-en-espagne') }}">
                                                <div class="media-body">
                                                    <p class="mb-0">Étudier en espagne</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6  mt-3">
                                    <div class="item">
                                        <div class="media">
                                            ...
                                            <a href="{{ url('fr/page/residence-non-lucrative') }}">
                                                <div class="media-body">
                                                    <p class="mb-0">Résidence non lucrative</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="media">
                                            ...
                                            <a href="{{ url('fr/page/renouvellement-de-la-carte-sejour-nie') }}">
                                                <div class="media-body">
                                                    <p class="mb-0">Renouvellement de la carte séjour (NIE)</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="NotreObjectif">
                            ...
                            <div class="media d-md-flex d-block justify-content-between">
                                <div class="media-body align-self-center">
                                    ...
                                    <p>Notre objectif est de vous fournir une assistance complète et personnalisée pour
                                        faciliter votre
                                        admission dans une
                                        université espagnole et vous permettre de réaliser votre rêve d'étudier en
                                        Espagne. <br>
                                        Nous sommes fiers de notre solide expérience et de notre savoir-faire dans le
                                        domaine de
                                        l'éducation internationale,
                                        ainsi que de notre capacité à répondre aux besoins uniques de chaque étudiant.
                                    </p>
                                </div>
                                <img src="{{ asset('img/cercale.svg') }}" alt="img"
                        ...
                        <div class="lmmiWorld">
                            <h2><span>L’équipe Immi World</span></h2>
                            <p>Notre <strong>équipe multilingue</strong> se compose de professionnels expérimentés et
                                hautement
                                qualifiés, ayant <strong>une connaissance
                                    approfondie des règles et réglementations en matière d'études en Espagne.</strong>
                                Nous travaillons
                                en étroite
                                collaboration avec
                                vous pour comprendre vos objectifs d'études et vous guider tout au long du processus, en
                                veillant à ce
                                que votre demande
                                d'admission soit complète et que votre dossier de demande de visa soit préparé avec
                                soin.</p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 align-self-center">
                                    <div class="itemRightText">
                                        <h2><span>Chaque étudiant est</span> unique</h2>
                                        <p>Nous comprenons que chaque étudiant est unique, c'est pourquoi nous offrons
                                            des services
                                            personnalisés pour répondre à
                                            vos besoins individuels.
                                        </p>
                                        <p>Que vous ayez besoin d'aide pour trouver le programme d'études qui vous
                                            convient le mieux, pour
                                            remplir votre demande
                                            d'admission ou pour préparer votre dossier de demande de visa, nous sommes
                                            là pour vous
                                            accompagner à chaque étape du
                                            processus.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ImmiworldPropose">
                            <h2><span>C'est tout? Non,</span> Immiworld propose
                                encore un autre service</h2>
                            <div class="media">
                                <img src="{{ asset('img/VisaIconOrange.png') }}" alt="img" class="img-fluid">
                                <div class="media-body">
                                    <p>Nous proposons également un <span>service de visa non lucrative en
                                            Espagne,</span> destiné à ceux
                                        qui souhaitent résider en Espagne
                                        sans exercer d'activité professionnelle et sans y travailler. <br>
                                        Ce visa est idéal pour les retraités, les investisseurs ou les personnes
                                        souhaitant simplement
                                        profiter d'un séjour
                                        prolongé en Espagne. Notre équipe vous aidera à préparer votre dossier de
                                        demande de visa non
                                        lucrative, en vous
                                        fournissant des informations sur les exigences, les documents nécessaires et les
                                        délais.Vous aurez
                                        l'autorisation de
                                        travaille dés votre dexieme année en Espagne.</p>
                                </div>
                            </div>
                        </div>
