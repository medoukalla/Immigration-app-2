  ...
  <div class="nav-container w-container">
    <div class="nav-menu-wrapper"><a href="{{ route('frontend.index') }}" aria-current="page"
      ...
      <nav role="navigation" class="nav-menu w-nav-menu">
        ...
        <div class="menu-wrap">
          <div data-hover="true" data-delay="0" data-w-id="ba67b287-f196-4627-29a8-f080f7e8b20d"
            ...
            <nav class="nav-dropdown-list w-dropdown-list">
              <div class="nav-dropdown-link-wrapper">
                ...
                <a href="{{ route('frontend.arraigo_socioformativo') }}" class="nav-dropdown-link w-dropdown-link">
                ...
                <a href="{{ route('frontend.residencia_para_emprendedores') }}"
                ...
                <a href="{{ route('frontend.nomada_digital') }}" class="nav-dropdown-link w-dropdown-link">
                  <span class="nav-dropdown-link-line"></span>Digital nomads
                </a>
          ...
          <div data-hover="true" data-delay="0" data-w-id="ba67b287-f196-4627-29a8-f080f7e8b20d"
            ...
            <nav class="nav-dropdown-list w-dropdown-list">
              <div class="nav-dropdown-link-wrapper">
                <a href="{{ route('frontend.visa_de_estudiante') }}" aria-current="page"
          ...
          <div data-hover="true" data-delay="0" data-w-id="ba67b287-f196-4627-29a8-f080f7e8b20d"
            ...
            <div class="nav-dropdown-toggle w-dropdown-toggle">
              <div class="nav-dropdown-icon w-icon-dropdown-toggle"></div>
              <p class="nav-item-title">Management Services</p>
            </div>
            <nav class="nav-dropdown-list w-dropdown-list">
              <div class="nav-dropdown-link-wrapper">
                <a href="{{ route('frontend.creacion_de_empresas') }}" class="nav-dropdown-link w-dropdown-link">
                  <span class="nav-dropdown-link-line"></span>Company Creation
                </a>
                <a href="{{ route('frontend.asesoria_fiscal_y_laboral') }}" class="nav-dropdown-link w-dropdown-link">
                  <span class="nav-dropdown-link-line"></span>Tax & Labor Consultancy
                </a>
                <a href="{{ route('frontend.certificado_digital_persona_fisica') }}"
                  class="nav-dropdown-link w-dropdown-link">
                  <span class="nav-dropdown-link-line"></span>Digital Certificate (Individual)
                </a>
                <a href="{{ route('frontend.certificado_digital_persona_juridica') }}"
                  class="nav-dropdown-link w-dropdown-link">
                  <span class="nav-dropdown-link-line"></span>Digital Certificate (Legal Entity)
                </a>
              </div>
            </nav>
          </div>
          ...
          <div data-hover="true" data-delay="0" data-w-id="ba67b287-f196-4627-29a8-f080f7e8b20d"
            ...
            <nav class="nav-dropdown-list w-dropdown-list">
              <div class="nav-dropdown-link-wrapper">
                <a href="{{ route('frontend.assurance') }}" aria-current="page"
                  class="nav-dropdown-link w-dropdown-link "><span class="nav-dropdown-link-line">
                  </span>Insurance</a>
                ...
                <div class="nav-sub-container inner-dropdown-fix">
                  {{-- Trigger link --}}
                  <div
                    class="nav-dropdown-link w-dropdown-link d-flex justify-content-between align-items-center cursor-pointer"
                    id="sub-toggle-civiles">

                    <div class="nav-link-content d-flex align-items-center">
                      <span class="nav-dropdown-link-line"></span>
                      <span class="nav-item-text">Civil Procedures</span>
                    </div>

                    <div class="nav-dropdown-icon w-icon-dropdown-toggle child-dropdown"></div>
                  </div>

                  {{-- Nested links hidden by default --}}
                  <nav class="sub-nested-menu" id="sub-list-civiles">
                    <div class="nav-dropdown-link-wrapper">
                      <a href="{{ route('frontend.pareja_de_hecho') }}" class="nav-dropdown-link w-dropdown-link">
                        <span class="nav-dropdown-link-line"></span>Civil Partnership
                      </a>
                      <a href="{{ route('frontend.matrimonio') }}" class="nav-dropdown-link w-dropdown-link">
                        <span class="nav-dropdown-link-line"></span>Marriage
                      </a>
                      <a href="{{ route('frontend.cancelacion_de_antecedentes_penales') }}"
                        class="nav-dropdown-link w-dropdown-link">
                        <span class="nav-dropdown-link-line"></span>Expungement of criminal records
                      </a>
                    </div>
                  </nav>
                </div>
          ...
          <div class="lang-wrapper mobile-lang">
            ...
            <div class="nav-mobile-bottom-btn">
              <div class="button-wrapper">
                <a href="javascript:void(0);" class="primary-button nav-tablet w-button openModalButton">Book a
                  Consultation</a>
              </div>
            </div>
          </div>
      ...
      <div class="menu-button w-nav-button">
        <img src="{{ asset('assets/images/svg/menu-btn.svg') }}" loading="lazy" alt="icon" height="16"
          class="image-burger" />
      </div>
    </div>
  </div>
...
<div id="calendlyModal" class="modal-overlay">
  <div class="modal-content">
    ...
    <!-- Calendly Embed Code -->
    <div class="calendly-inline-widget" data-url="https://calendly.com/d/y5v-9f3-ztd/marouane?primary_color=ff6524"
...
<style>
  ...
  .inner-dropdown-fix #sub-toggle-civiles {
    margin-left: 7px;
    /* English Comment: Match your default link style */
    padding-left: 0px;
  }
  ...
  .sub-nested-menu {
    display: none;
    padding-left: 30px;
    /* English Comment: Indent nested items for hierarchy */
  ...
  @media screen and (max-width: 991px) {
    ...
    .inner-dropdown-fix .nav-dropdown-icon {
      ...
      /* English Comment: Essential for proper rotation */
      transform-origin: center center;
      /* English Comment: Ensures rotation stays in the same spot */
      transform: rotate(360deg);
      /* English Comment: Your default downward state */
    ...
    .sub-nested-menu {
      ...
      /* English Comment: Reduced time for snappier feel */
      padding-left: 30px;
      background: transparent;
    }
    ...
    .inner-dropdown-fix.w--open #sub-list-civiles {
      max-height: 500px;
      /* English Comment: Large enough value to fit all links */
    }
  }
</style>
