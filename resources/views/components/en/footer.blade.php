      ...
      <div class="home-1-map-block">
        ...
        <div class="_1-home-map-block">
          <div class="map-2 w-widget w-widget-map" data-widget-style="roadmap" data-widget-latlng="" aria-label=""
            ...
            data-widget-tooltip=""></div><img src="{{ asset('assets/images/google-map.svg') }}" loading="lazy"
            sizes="(max-width: 479px) 94vw, (max-width: 767px) 96vw, (max-width: 1279px) 58vw, (max-width: 1919px) 702px, 822px"
            srcset="{{ asset('assets/images/google-map.svg') }} 1680w" alt="map" class="map-1-temporary-image" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="base-container w-container">
    <div class="footer-wrapper">
      <div class="footer-links-wrapper">
        <div class="logo">
          <img src="{{ asset('assets/images/logo/logo-white-png (1).png') }}" alt="Logo"
            style=" max-width: 50% !important;!i;!; float: left; ">
        </div>
        <div class="thanks">
          <p>At Immiworld, we are experts in immigration and residency services, dedicated to streamlining your
            residency application process in Spain efficiently and reliably.</p>
        </div>
...
<script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=651f2c08c5bd81eb296c17aa"
