<div class="banner-section-photo">
    <div data-w-id="cc582f0b-75ba-d7bd-9fe3-5b2888ed64e5" style="opacity:0" class="banner-content-container">
      <h1 data-w-id="cc582f0b-75ba-d7bd-9fe3-5b2888ed64e6" style="opacity:0" class="home-title">Your Gateway to a
        Seamless Immigration</h1>
      <p data-w-id="cc582f0b-75ba-d7bd-9fe3-5b2888ed64e8" style="opacity:0" class="home-main-banner-discription">
        We&#x27;re here to guide you every step of the way. Our experienced team of experts is dedicated to making your
        journey to a new country as smooth and stress-free as possible.</p>
      <div data-w-id="cc582f0b-75ba-d7bd-9fe3-5b2888ed64ea" style="opacity:0" class="buttons-wrapper"><a
          href="/services" class="primary-button w-button">Explore details</a></div>
    </div>
