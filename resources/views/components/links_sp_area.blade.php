<div class="linkArea">
    <a class="itemLink d-block media-hight chat-button" href="javascript:void(0)">
        <span class="media">
            <!--?xml version="1.0" encoding="UTF-8"?--><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 27.83 21.78">
            ...
            <span class="media-body">
                <p class="mb-0">Hable con un agente en línea</p>
            </span>

        </span>
    </a>

    <a class="itemLink d-block media-hight" href="{{ route('frontend.sp.index') . '#consulting' }}">
        <span class="media">
            <!--?xml version="1.0" encoding="UTF-8"?--><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="media-body">
                <p class="mb-0">Consultas telefónicas con un experto</p>
            </span>
        </span>
    </a>
    <a class="itemLink d-block media-hight" href="{{ setting('site.whatsapp_link') }}" target="_blanck">
        <span class="media">
            <!--?xml version="1.0" encoding="UTF-8"?--><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 27.83 27.96">
            ...
            <span class="media-body">
                <p class="mb-0">Hable con un agente a través de Whatsapp</p>
            </span>
        </span>
    </a>
</div>
