<div class="linkArea">
    <a class="itemLink d-block chat-button media-hight" href="javascript:void(0)">
        <span class="media">
            ...
            <span class="media-body">
                <p class="mb-0">Discutez avec un agent en ligne</p>
            </span>

        </span>
    </a>

    <a class="itemLink d-block media-hight" href="{{ route('frontend.index') . '#consulting' }}">
        <span class="media">
            <!--?xml version="1.0" encoding="UTF-8"?--><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
    ...
    <a class="itemLink d-block media-hight" href="{{ setting('site.whatsapp_link') }} media-hight" target="_blanck">
        <span class="media">
            <!--?xml version="1.0" encoding="UTF-8"?--><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
