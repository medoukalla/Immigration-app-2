                    ...
                    <div class="panel-body">
                        <table id="dataTable" class="table table-hover">
                            ...
                            <tr>
                                ...
                                @endforeach
                                <th class="actions text-end">{{ __('voyager::generic.actions') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endforeach
                                    <td class="no-sort no-click bread-actions text-end">
                                        @can('delete', $data)
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
                        <input type="submit" class="btn btn-label-danger waves-effect pull-right delete-confirm" value="{{ __('voyager::generic.delete_this_confirm') }} {{ $dataType->getTranslatedAttribute('display_name_singular') }}">
                    </form>
