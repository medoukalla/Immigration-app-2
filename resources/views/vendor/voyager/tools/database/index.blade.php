    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped database-tables datatables-basic  dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td class="actions text-end">
                            ...
                            <a href="{{ route('voyager.database.show', $table->prefix.$table->name) }}"
                                ...
                                class="btn btn-sm btn-label-warning waves-effect pull-right desctable" style="display:inline; margin-right:10px;">
                                <i class="voyager-eye"></i> {{ __('voyager::generic.view') }}
                             </a>

                            <a href="{{ route('voyager.database.edit', $table->prefix.$table->name) }}"
                               class="btn btn-sm btn-label-primary waves-effect pull-right" style="display:inline; margin-right:10px;">
                               <i class="voyager-edit"></i> {{ __('voyager::generic.edit') }}
                            </a>
                            
                            <a class="btn btn-sm btn-label-danger waves-effect  pull-right delete_table @if($table->dataTypeId) remove-bread-warning @endif"
