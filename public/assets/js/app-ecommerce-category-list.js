...
commentEditor && new Quill(commentEditor, {
        ...
        var o, s = $(".datatables-category-list"),
            r = $(".select2");
        ...
        }), $(".dt-action-buttons").addClass("pt-0"), $(".dataTables_filter").addClass("me-3 ps-0")), $(".datatables-category-list tbody").on("click", ".delete-record", function() {
