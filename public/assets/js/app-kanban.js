...
!async function() {
    ...
    c.ok || console.error("error", c), c = await c.json(), d && d.flatpickr({
    ...
    const v = new jKanban({
            ...
            click: function(e) {
                var t = e,
                    ...
                    i = new Date,
                    d = i.getFullYear(),
                    n = n ? n + ", " + d : i.getDate() + " " + i.toLocaleString("en", {
                        month: "long"
                    }) + ", " + d,
            ...
            buttonClick: function(e, a) {
                ...
                n.setAttribute("class", "new-item-form"), n.innerHTML = '<div class="mb-3"><textarea class="form-control add-new-item" rows="2" placeholder="Add Content" autofocus required></textarea></div><div class="mb-3"><button type="submit" class="btn btn-primary btn-sm me-2 waves-effect waves-light">Add</button><button type="button" class="btn btn-label-secondary btn-sm cancel-add-item waves-effect waves-light">Cancel</button></div>', v.addForm(a, n), n.addEventListener("submit", function(e) {
                    e.preventDefault();
    ...
    k && k.forEach(function(e) {
        ...
        let i = "";
        null !== e.getAttribute("data-image") && (i = "<img class='img-fluid rounded mb-2' src='" + l + "img/elements/" + e.getAttribute("data-image") + "'>"), e.textContent = "", void 0 !== e.getAttribute("data-badge") && void 0 !== e.getAttribute("data-badge-text") && e.insertAdjacentHTML("afterbegin", (t = e.getAttribute("data-badge"), a = e.getAttribute("data-badge-text"), "<div class='d-flex justify-content-between flex-wrap align-items-center mb-2 pb-1'><div class='item-badges'> <div class='badge rounded-pill bg-label-" + t + "'> " + a + "</div></div>" + m() + "</div>" + i + n)), void 0 === e.getAttribute("data-comments") && void 0 === e.getAttribute("data-due-date") && void 0 === e.getAttribute("data-assigned") || e.insertAdjacentHTML("beforeend", (t = e.getAttribute("data-attachments"), a = e.getAttribute("data-comments"), n = e.getAttribute("data-assigned"), e = e.getAttribute("data-members"), "<div class='d-flex justify-content-between align-items-center flex-wrap mt-2 pt-1'><div class='d-flex'> <span class='d-flex align-items-center me-2'><i class='ti ti-paperclip ti-xs me-1'></i><span class='attachments'>" + t + "</span></span> <span class='d-flex align-items-center ms-1'><i class='ti ti-message-dots ti-xs me-1'></i><span> " + a + " </span></span></div><div class='avatar-group d-flex align-items-center assigned-avatar'>" + p(n, !0, "xs", null, e) + "</div></div>"))
    });
    ...
    }), r && r.addEventListener("shown.bs.offcanvas", function() {
