...
$(function() {
    ...
    n.length && (t = n.DataTable({
        ...
        columnDefs: [{
            ...
            render: function(t, e, a, s) {
                a = a.payment, a = o[a];
                return a ? '<h6 class="mb-0 align-items-center d-flex w-px-100 ' + a.class + '"><i class="ti ti-circle-filled fs-tiny me-2"></i>' + a.title + "</h6>" : t
            }
        }, {
            targets: -3,
            render: function(t, e, a, s) {
            ...
            render: function(t, e, a, s) {
                var n = a.method,
                    a = a.method_number;
                return "paypal_logo" == n && (a = "@gmail.com"), '<div class="d-flex align-items-center text-nowrap"><img src="' + assetsPath + "img/icons/payments/" + n + '.png" alt="' + n + '"class="me-2" width="16"><span><i class="ti ti-dots me-1 mt-n1"></i>' + a + "</span></div>"
            }
        }, {
            targets: -1,
            title: "Actions",
    ...
    }), $(".dataTables_length").addClass("mt-0 mt-md-3 ms-n2"), $(".dt-action-buttons").addClass("pt-0"), $(".dataTables_filter").addClass("ms-n3")), $(".datatables-order tbody").on("click", ".delete-record", function() {
