...
$(function() {
    ...
    t.length && (t.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 6,
            render: function(t, e, s, a) {
                return '<span class="h6 mb-0">' + s.earning + "</span > "
            }
        }],
        order: [
            [2, "asc"]
    ...
    }), $("div.head-label").html('<h5 class="card-title text-nowrap mb-2 mb-sm-0">Referred users</h5>'), $(".dataTables_length").addClass("mt-0 mt-md-3 me-2 ms-n2 ms-sm-0"), $(".dt-action-buttons").addClass("pt-0")), setTimeout(() => {
