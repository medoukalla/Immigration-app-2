...
! function() {
    ...
    var n, o, a, l, i, r, e = $(".btn-apply-changes"),
        t = $(".source-item"),
        c = {
    ...
    $(document).on("click", ".tax-select", function(e) {
        ...
        var t = $(this);
        i = t.closest(".dropdown-menu").find("#taxInput1"), r = t.closest(".dropdown-menu").find("#taxInput2"), l = t.closest(".dropdown-menu").find("#discountInput"), o = t.closest(".repeater-wrapper").find(".tax-1"), a = t.closest(".repeater-wrapper").find(".tax-2"), n = $(".discount"), null !== i.val() && p(i, o), null !== r.val() && p(r, a), l.val().length && t.closest(".repeater-wrapper").find(n).text(l.val() + "%")
