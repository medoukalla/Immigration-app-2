    ...
    $("#closeButton").on("click", function() {
        ...
        var t = $("#toastTypeGroup input:radio:checked").val(),
            ...
            o = (toastr.options = {
                ...
                onclick: null,
                rtl: e
            }, v != toastr.options.positionClass && (toastr.options.hideDuration = 0, toastr.clear()), $("#addBehaviorOnToastClick").prop("checked") && (toastr.options.onclick = function() {
            ...
            m = toastr[t](o, s);
        void 0 !== (f = m) && (m.find("#okBtn").length && m.delegate("#okBtn", "click", function() {
