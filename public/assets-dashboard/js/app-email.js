...
document.addEventListener("DOMContentLoaded", function() {
    {
        ...
        if (r && new PerfectScrollbar(r, {
                ...
                e.addEventListener("click", e => {
                    ...
                    m.classList.remove("show"), u.classList.remove("show"), Helpers._removeClass("active", d), t.classList.add("active"), i.forEach(e => {
                ...
                }), g.indeterminate = !1, g.checked = !1, 0 == document.querySelectorAll(".email-list-item").length && q.classList.remove("d-none")
