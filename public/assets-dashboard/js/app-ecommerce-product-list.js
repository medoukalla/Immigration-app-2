...
$(function() {
        ...
        columnDefs: [{
            ...
            render: function(t, e, s, a) {
                var n = s.product_name,
                    ...
                    o = s.product_brand,
                    c = s.image;
                return '<div class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper"><div class="avatar avatar me-2 rounded-2 bg-label-secondary">' + (c ? '<img src="' + assetsPath + "img/ecommerce-images/" + c + '" alt="Product-' + i + '" class="rounded-2">' : '<span class="avatar-initial rounded-2 bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (c = (((c = (n = s.product_brand).match(/\b\w/g) || []).shift() || "") + (c.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><h6 class="text-body text-nowrap mb-0">' + n + '</h6><small class="text-muted text-truncate d-none d-sm-block">' + o + "</small></div></div>"
            }
        }, {
            targets: 3,
    ...
    }), $(".dataTables_length").addClass("mt-2 mt-sm-0 mt-md-3 me-2"), $(".dt-buttons").addClass("d-flex flex-wrap")), $(".datatables-products tbody").on("click", ".delete-record", function() {
