        ...
        columnDefs: [{
            ...
            render: function(e, a, t, r) {
                var s = t.project_img,
                    d = t.project_name,
                    n = t.date;
                return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar me-2">' + (s ? '<img src="' + assetsPath + "img/icons/brands/" + s + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (s = (((s = (d = t.project_name).match(/\b\w/g) || []).shift() || "") + (s.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="text-truncate fw-medium">' + d + '</span><small class="text-truncate text-muted">' + n + "</small></div></div>"
            }
        }, {
            targets: 4,
            orderable: !1,
            searchable: !1,
            render: function(e, a, t, r) {
                for (var s = t.team, d = '<div class="d-flex align-items-center avatar-group">', n = 0; n < s.length; n++) d += '<div class="avatar avatar-sm"><img src="' + assetsPath + "img/avatars/" + s[n] + '" alt="Avatar" class="rounded-circle pull-up"></div>';
                return d += "</div>"
            }
        }, {
            targets: -2,
