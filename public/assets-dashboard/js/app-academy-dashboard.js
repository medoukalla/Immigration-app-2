...
! function() {
    ...
    var n, s = document.querySelectorAll(".chart-progress"),
        a = (s && s.forEach(function(e) {
    ...
    a.length && (n = a.DataTable({
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, s) {
                ...
                return '<span class="h6 mb-0 text-nowrap">' + (r + "h " + (Math.floor(e.asMinutes()) - 60 * r) + "m") + "</span>"
            }
        }, {
            targets: 4,
            render: function(e, t, a, s) {
                var r = a.status;
                return '<div class="d-flex align-items-center gap-3"><p class="h6 mb-0">' + r + '</p><div class="progress w-100" style="height: 8px;"><div class="progress-bar" style="width: ' + r + '" aria-valuenow="' + r + '" aria-valuemin="0" aria-valuemax="100"></div></div><small class="text-muted">' + a.number + "</small></div>"
            }
        }, {
            targets: 5,
            render: function(e, t, a, s) {
                return '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="ti ti-users ti-sm me-2 text-primary"></i>' + a.user_number + '</div><div class="w-px-50 d-flex align-items-center"><i class="ti ti-book ti-sm me-2 text-info"></i>' + a.note + '</div><div class="w-px-50 d-flex align-items-center"><i class="ti ti-video ti-sm me-2 text-danger" ></i>' + a.view + "</div></div>"
            }
        }],
        order: [
            [2, "desc"]
