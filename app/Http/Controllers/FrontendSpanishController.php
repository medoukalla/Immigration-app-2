...
class FrontendSpanishController extends Controller
{
    // index page 
    ...
    public function arraigo_socioformativo()
    {
        ...
        return view('frontend.sp.arraigo_socioformativo', [
            'testimonials' => $testimonials,
        ]);
    }
    ...
    public function arraigo_segunda_oportunidad()
    {
        ...
        return view('frontend.sp.arraigo_segunda_oportunidad', [
            'testimonials' => $testimonials,
        ]);
    }
    ...
    {
        $testimonials = Testimonial::where('active', true)->where('lang', 'es')->get();
        return view('frontend.sp.residencia_cuenta_propia', ['testimonials' => $testimonials]);
    }

    public function residencia_cuenta_ajena()
    {
        $testimonials = Testimonial::where('active', true)->where('lang', 'es')->get();
        return view('frontend.sp.residencia_cuenta_ajena', ['testimonials' => $testimonials]);
    }
    ...
    {
        $posts = Post::where('lang', 'es')->orderBy('id', 'desc')->simplePaginate(15);
